...
document.getElementById("start_proj_mot").addEventListener("click", function(event) {
...
document.getElementById("reset_proj_mot").addEventListener("click", function(event) {
    event.preventDefault();
    reset_proj_mot_canvas()
